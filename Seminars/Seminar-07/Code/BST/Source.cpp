// Code from the Seminar of Angel Dimitriev
// Link: https://github.com/Angeld55/Data_structures_and_algorithms_FMI
// Note - includes BST iterator task from Seminar 6
